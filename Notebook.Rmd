...
We load all the neccesary libraries
```{r, include = FALSE}
library(mice)
library(GGally)
library(caret)
...
data partition and and display check
```{r}
...
# Define the reduced formula based on your feature importance analysis (adjust this list based on your output)
